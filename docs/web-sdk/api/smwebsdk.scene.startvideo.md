...
|  --- | --- | --- |
|  videoElement | HTMLVideoElement | <i>(Optional)</i> Optional parameter specifying the video element hosting the Digital Person. If not specified the video element passed to the Scene constructor will be used. |
