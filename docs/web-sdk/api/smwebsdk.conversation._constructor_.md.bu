...
|  --- | --- | --- |
|  logger | Logger | <i>(Optional)</i> |
|  conversationState | [ConversationState](./smwebsdk.conversationstate.md) | <i>(Optional)</i> |
|  contentCardFormatter | [ContentCardFormatter](./smwebsdk.contentcardformatter.md) | <i>(Optional)</i> |
