...
|  --- | --- | --- |
|  audioSource | AudioSourceTypes | <i>(Optional)</i> The audio source either smwebsdk.audioSource.processed or smwebsdk.audioSource.squelched, defaults to processed. |
